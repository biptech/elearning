...
if (isset($_POST['update'])) {
    ...
    if ($new_image != "") {
        ...
        $con->query("UPDATE products SET name='$name', price='$price', image='$rename', category_id='$category_id' WHERE id=$id");
    } else {
        $con->query("UPDATE products SET name='$name', price='$price', category_id='$category_id' WHERE id=$id");
    }
...
<head>
    ...
    <style>
        ...
        .main-container { max-width: 800px; margin: auto; background: white; padding: 20px; border-radius: 8px; box-shadow: 0 0 10px #ccc; }
        .form-group { margin-bottom: 20px; }
        .form-label { font-weight: bold; }
        .form-input, .form-select { width: 100%; padding: 10px; border-radius: 4px; border: 1px solid #ddd; }
...
<div class="main-container">
    ...
    <form method="POST" enctype="multipart/form-data">
        ...
        <div class="form-group">
            ...
            <br><img src="uploaded_files/<?= $product['image'] ?>" width="80">
        </div>
